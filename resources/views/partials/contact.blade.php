        ...
        <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
                    ...
                    <h3 class="text-lg font-medium text-white">Informations de contact</h3>
                    <p class="mt-6 text-base text-indigo-50 max-w-3xl">Nullam risus blandit ac aliquam justo ipsum. Quam
                    ...
                    <dl class="mt-8 space-y-6">
                        ...
                        <dd class="flex text-base text-indigo-50">
                            ...
                            <span class="ml-3">+33 6 52 02 99 89</span>
                        </dd>
                        ...
                        <dd class="flex text-base text-indigo-50">
                            ...
                            <span class="ml-3">gerault-alexandre@orange.fr</span>
                        </dd>
                    </dl>
                    <ul class="mt-8 flex space-x-12" role="list">
                        <li>
                            <a class="text-indigo-200 hover:text-indigo-100"
                               href="https://www.linkedin.com/in/alexandreg%C3%A9rault/">
                                <span class="sr-only">Facebook</span>
                                <svg width="24" height="24" viewBox="0 0 256 256" version="1.1"
                        ...
                        <li>
                            <a class="text-indigo-200 hover:text-indigo-100" href="https://github.com/AlexandreGerault">
                        ...
                        <li>
                            <a class="text-indigo-200 hover:text-indigo-100" href="https://twitter.com/AlexandreGraul1">
                ...
                <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                    <h3 class="text-xl font-medium text-gray-900">Me contacter</h3>
